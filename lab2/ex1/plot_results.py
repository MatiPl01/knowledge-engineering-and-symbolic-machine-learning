...
def plot_learning_curve(data_path='results/results.csv', window_size=100):
    # Read the CSV file
    data = pd.read_csv(data_path)
    
    # Find the point where epsilon becomes 0
    convergence_point = data[data['Epsilon'] == 0].index[0]
